...
## ROCm-6.3.0 Ollama and OpenWebui in a Dockerfile

|OS            |Python|ROCm |Ollama|GPU|Mapping Port|
|--------------|------|-----|------|-----|-----|
|Ubuntu-24.04|3.12|6.3.0|v0.6.5|RX570/580/590 aka Polaris 20/21 aka GCN 4|8080,11434|
